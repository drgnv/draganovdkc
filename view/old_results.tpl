                ...
                <td valign="top">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input required type="text" name="number" value="{$data2.0.number}" size="1" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td style="color: white;">{$lang.patient}:</td>
                            <td>
                                <input required type="text" name="patient" value="{$data2.0.names}" size="26" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td style="color: white;">{$lang.idn}:</td>
                            <td>
                                <input type="text" name="idn" value="{$data2.0.idn}" size="9" readonly>
                            </td>
                        </tr>
                        <tr>
